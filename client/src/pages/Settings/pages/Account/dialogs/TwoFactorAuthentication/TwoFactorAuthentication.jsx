        ...
        <DialogProvider open={open} onClose={onClose}>
            <div className="two-factor-dialog" onKeyDown={(event) => event.key === "Enter" && enableTotp()}>
                <div className="info-area">
                    <h1>Enable 2FA</h1>
                    <p>Scan the code with your authenticator app or enter <span className="totp-code">{totpObj?.secret}</span> manually</p>

                    <div className="action-row">
                        <IconInput icon={mdiKey} placeholder="Enter code" value={code} setValue={setCode}
